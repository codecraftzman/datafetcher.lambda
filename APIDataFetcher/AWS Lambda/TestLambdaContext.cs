...
namespace APIDataFetcher
{
    ...
    public class TestLambdaContext : ILambdaContext
    {
        ...
        /// </summary>
        public string AwsRequestId { get; set; } = default!;

        /// <summary>
        /// Information about the client application and device when invoked
        /// through the AWS Mobile SDK.
        /// </summary>
        public IClientContext ClientContext { get; set; } = default!;
        ...
        /// </summary>
        public ICognitoIdentity Identity { get; set; } = default!;

        /// <summary>
        /// The ARN used to invoke this function.
        /// </summary>
        public string InvokedFunctionArn { get; set; } = default!;
        ...
        /// </summary>
        public string LogGroupName { get; set; } = default!;

        /// <summary>
        /// The CloudWatch log stream name for this function execution.
        /// </summary>
        public string LogStreamName { get; set; } = default!;
